...
CAND = {"pond_settled_flow_thin","pond_settled_flow","pond_settled_flow_solcap",
        ...
        "badday_flush","young_probe_stair_convex","young_probe_baseflow_convex","badday_flush_convex","young_probe_thinliq","young_probe_mid","young_probe_late","timebox_probe"}
