"""Verify the catalog of 97 bots: each loads, each differs from baseline
...
def test_catalog_has_97_bots(catalog):
    assert len(catalog.configs) == 97, (
        f"Expected 97 bots, got {len(catalog.configs)}: "
