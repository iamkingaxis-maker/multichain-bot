...
class Config:
    ...
    dip_winner_trail_pct: float = 2.0     # Tightened 3.5 → 2.0 on 2026-05-10. Trail give-back audit (n=24 post-CB trail exits) showed empirical give-back was median 5.9% / mean 7.3% — 2× the configured 3.5%, due to 5s management cycle latency. Tightening to 2.0% reduces median give-back ~1.5pp, estimated +$3.60 / 5d on the 24-trail cohort. Risk (TP2 winners exiting early on 1.5%+ mid-recovery dip) is small since trail only fires post-TP1 and TP2 sits at +12% (just +4pp above TP1).
